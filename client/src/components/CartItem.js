				...
				<>
					...
					<div className="cart-item-info" >
						...
						<span className="cart-item-price-info">
							...
							<>
							• <span className="cart-item-offer">{Math.trunc(((product.price - product.rate) / product.price) * 100)}% off</span> •
						...
						<div className="cart-item-actions" >
							...
							<button className="cart-item-decr" onClick={()=>{dispatch({type: 'REMOVE_ITEM', payload: { id: productId, option, price: product.rate, original: product.price }})}} >-</button>
